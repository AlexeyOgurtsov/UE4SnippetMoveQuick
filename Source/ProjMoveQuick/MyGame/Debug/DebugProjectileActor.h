...
#include "Util/TestUtil/ProjectileConfig.h"
#include "DebugProjectileActor.generated.h"
...
UCLASS()
class ADebugProjectileActor : public ATUActor
{
	GENERATED_BODY()

public:
	ADebugProjectileActor();
...
// ~ RightHere_ADebugProjectileActor Begin


// Adhoc impl lines (WARNING! move to .cpp file, otherwise will fail to compile!)
// ~ RightHere_ADebugProjectileActor End
